...
### 2.2.1-dev (3 November 2025) ###
* Fix warning message on the plugin's settings page for users who aren't using SimpleSAML [[#423](https://github.com/pantheon-systems/wp-saml-auth/pull/423)].
* Adds PHP 8.4 compatibility [[#410](https://github.com/pantheon-systems/wp-saml-auth/pull/410)].
* Increases minimum supported PHP version to 7.4.
* Adds WordPress 6.9 compatibility [[#437](https://github.com/pantheon-systems/wp-saml-auth/pull/437)].
