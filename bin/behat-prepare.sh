...
TARG_GZ_URL="https://github.com/simplesamlphp/simplesamlphp/releases/download/${SIMPLE_SAML_PHP_VERSION}/simplesamlphp-${SIMPLE_SAML_PHP_VERSION#v}-full.tar.gz"
